...
import { DownloadSimple, HardDrives, MagnifyingGlass, X, MusicNotes, FolderOpen } from '@phosphor-icons/react'
      ...
      <ScrollArea className="flex-1 px-4 lg:px-8 pb-6">
          ...
          >
            <div className="flex items-center justify-between mb-2.5">
              <div className="flex items-center gap-2">
                <DownloadSimple className="w-4 h-4 text-[var(--accent)]" />
        ...
        <section>
          ...
          {!loadingLocal && localCount > 0 && filteredTracks.length === 0 && (
            ...
            >
              <MusicNotes className="w-9 h-9 text-[var(--text-muted)]" />
          ...
          {!loadingLocal && filteredTracks.length > 0 && (
            <>
              ...
              <div className="flex items-center gap-2 mb-4 px-3 py-2.5 rounded-2xl bg-[var(--bg-elevated)] border border-[var(--border)]">
                <HardDrives className="w-4 h-4 text-[var(--text-muted)] flex-shrink-0" />
