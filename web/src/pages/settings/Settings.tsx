      ...
      items: [
         {
            id: "appearance",
            label: "Appearance",
            desc: "Theme, accent, transparency",
            Icon: Palette,
            bg: "#8B5CF6"
         },
         {
         ...
         },
         {
            id: "downloads",
            label: "Downloads",
            desc: "Format, quality, concurrency",
            Icon: Download,
            bg: "#22C55E"
         },
         {
            id: "storage",
            label: "Storage",
            desc: "Directories, library, cache",
            Icon: HardDrive,
            bg: "#F97316"
         }
      ]
   },
   {
      ...
      items: [
         ...
         },
         {
            id: "account",
            label: "Account",
            desc: "Profile, Spotify credentials",
            Icon: User,
            bg: "#EC4899"
         },
         {
...
export default function Settings() {
   ...
   const meta = ALL_SECTIONS.find(s => s.id === active) ?? null;
               ...
               {active && meta ? (
                  <motion.div
                     ...
                     <div className='flex items-center gap-3 px-4 lg:px-5 pt-12 pb-2 flex-shrink-0'>
                        <motion.button
                           ...
                           className='lg:hidden flex items-center gap-1 text-[var(--accent)]'>
                  ...
                  <motion.div
                     ...
                     <div className='text-center'>
                        ...
                        <p className='text-[13px] text-[var(--text-muted)] mt-0.5'>
                           Configure Shulker from the sidebar
                        </p>
                     </div>
                  </motion.div>
               )}
