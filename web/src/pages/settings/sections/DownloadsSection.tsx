					...
					options={[
						{
							value: 'mp3',
							label: 'MP3',
							sub: 'Universal — works everywhere'
						},
						{
							value: 'flac',
							label: 'FLAC',
							sub: 'Lossless — largest file size'
						},
						{
							value: 'opus',
							label: 'Opus',
							sub: 'Best quality/size ratio — modern'
						},
						{
							value: 'm4a',
							label: 'M4A',
							sub: 'Apple format — AAC codec'
						},
						{
							value: 'wav',
							label: 'WAV',
							sub: 'Uncompressed — huge files, max quality'
						}
					]}
				/>
			</SettingsGroup>
				...
				<RadioGroup
					...
					options={[
						...
						},
						{
							value: '320',
							label: '320 kbps',
							sub: 'Best MP3 quality'
						},
						{
							value: 'best',
							label: 'Best available',
							sub: 'Whatever yt-dlp can get'
						}
					]}
				/>
			</SettingsGroup>
