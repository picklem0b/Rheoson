...
export default function AppearanceSection() {
	const { theme, setAccent, setSurface, glassOpacity, setGlassOpacity } =
		useThemeStore();
				...
				<div>
					<div className='px-4 pt-3.5 pb-1'>
						...
						<p className='text-xs text-[var(--text-muted)] mt-0.5'>
							Controls how opaque the sidebar, player bar, and
							overlays appear
						</p>
					</div>
					<Slider
