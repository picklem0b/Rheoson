...
**Version:** `2.16.4` in `api/pyproject.toml`, `web/package.json`, `web/src/lib/constants.ts`, and `api/app/main.py`. Keep these in sync.  
...
- `api/pyproject.toml` → `version = "2.16.4"`
- `web/package.json` → `"version": "2.16.4"`
- `web/src/lib/constants.ts` → `APP_VERSION = "2.16.4"`
- `api/app/main.py` → `VERSION = "2.16.4"`
