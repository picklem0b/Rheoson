...
- `api/pyproject.toml` → `version = "2.19.14"` (then run `uv lock` — `uv.lock` carries it too)
- `web/package.json` → `"version": "2.19.14"`
- `web/src/lib/constants.ts` → `APP_VERSION = "2.19.14"`
- `api/app/main.py` → `VERSION = "2.19.14"`
