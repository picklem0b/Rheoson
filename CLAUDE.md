...
> Version: 2.19.8 · Long-form docs: [docs/README.md](docs/README.md) · Roadmap: [docs/ROADMAP.md](docs/ROADMAP.md) · Release process: [GIT_WORKFLOW.md](GIT_WORKFLOW.md)
...
- `api/pyproject.toml` → `version = "2.19.8"` (then run `uv lock` — `uv.lock` carries it too)
- `web/package.json` → `"version": "2.19.8"`
- `web/src/lib/constants.ts` → `APP_VERSION = "2.19.8"`
- `api/app/main.py` → `VERSION = "2.19.8"`
