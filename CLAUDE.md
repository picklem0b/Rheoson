...
> Version: 2.17.7 · Long-form docs: [docs/README.md](docs/README.md) · Release process: [GIT_WORKFLOW.md](GIT_WORKFLOW.md)
...
- `api/pyproject.toml` → `version = "2.17.7"` (then run `uv lock` — `uv.lock` carries it too)
- `web/package.json` → `"version": "2.17.7"`
- `web/src/lib/constants.ts` → `APP_VERSION = "2.17.7"`
- `api/app/main.py` → `VERSION = "2.17.7"`
